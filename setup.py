...
setup(
    ...
    #
    # And where it will live on PyPI: https://pypi.org/project/karenina/
    #
    ...
    # project.
    author='Jesse Zaneveld',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='zaneveld@gmail.com',  # Optional
    ...
    keywords='karenina ornstein uhlenbeck brownian motion',  # Optional
    ...
    #
    packages=find_packages(exclude=['docs', 'tests', 'q2-karenina']),  # Required
    ...
    #install_requires=['ffmpeg'],  # Optional
